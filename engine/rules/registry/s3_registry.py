...
S3_RULES = [
    ...
    RuleDefinition(
        ...
        collection_mode="multiple",
        check_arguments=["bucket_name", "encryption_configuration"],
    ...
    RuleDefinition(
        ...
        collection_mode="multiple",
        check_arguments=["bucket_name", "policy_status"],
    ...
    RuleDefinition(
        ...
        data_source="s3_acl",
        collection_mode="multiple",
        check_arguments=["bucket_name", "acl"],
        check=check_s3_acl,
    ...
    RuleDefinition(
        ...
        collection_mode="multiple",
        check_arguments=["bucket_name", "versioning"],
    ...
    RuleDefinition(
        ...
        collection_mode="multiple",
        check_arguments=["bucket_name", "logging"],
    ...
    RuleDefinition(
        ...
        collection_mode="multiple",
        check_arguments=["bucket_name", "object_lock_configuration"],
    ...
    RuleDefinition(
        ...
        collection_mode="multiple",
        check_arguments=["bucket_name", "ownership_configuration"],
